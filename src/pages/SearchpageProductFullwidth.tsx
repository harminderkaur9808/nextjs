...
import '../styles/SearchpageProductFullwidth.css';
...
const SearchpageProductFullwidth: React.FC = () => {
      ...
      <div className="Main-search-page">
        ...
        <section className='Section-boxes-producta'>
          ...
          {currentProducts.map((product, index) => (
            ...
            <div key={index} className="product-box-Product-full">
              <div className="product-image-001">
                <Image src={product.image} alt={product.name}  width={220} height={10}/>
              </div>
...
export default SearchpageProductFullwidth;
